...
import UIKit
import CoreLocation
//import this for any webpage where we need to access user location
...
class DetailVC: UIViewController {
    ...
    //only need the location when we're on the first page (0)
    ...
    func updateUserInterface() {
        ...
        print("icon ", locationDetail.currentIcon)
...
extension DetailVC: CLLocationManagerDelegate{
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .restricted:
            print("Access denied. Likely parental controls are restrict location services in the app.")
        }
    }
